...
//
//    Actualizado el 10 de octubre de 2021 por:
...
//    https://github.com/vcubells/tc1031/tree/master/Tema_7_Estructuras%20lineales
//
...
/* Menu de opciones para una IP dada */
void menuIP(VectorRegistros &registros){
    std::string ip_user;
    int option_ip = 0;
    Node<Registro> * tmp;

    cout << "Ingrese la dirección IP: ";
    cin >> ip_user;

    ConexionesComputadora * computadora = new ConexionesComputadora(ip_user, registros);

    cout << "*   IP usada: " << computadora->getIP() << "    *" << endl << endl;

    do{ 
        cout << "      --MENU IP--" << endl;
        cout << "1. Ultima conexion recibida." << endl;
        cout << "2. Ultima conexion saliente." << endl;
        cout << "3. Numero de conexiones entrantes." << endl;
        cout << "4. Numero de conexiones salientes" << endl;
        cout << "5. ¿Existen un sitio web visitado tres veces seguidas?" << endl;
        cout << "6: Mostrar sitios web visitados" << endl;
        ...
        switch (option_ip){
        case 1:
            tmp = computadora->ultimaConexionEntrante();
            
            if ( computadora->isInterna(tmp) )
                cout << "Ultima conexion entrante (interna): " << endl;
            else 
                cout << "Ultima conexion entrante (externa): " << endl;
        ...
        case 2:
            cout << endl << "Ultima conexion saliente: ";
            cout << computadora->ultimaConexionSaliente() << endl;
            break;
        
        case 3:
            cout << endl << "Hay " << computadora->numeroConexionesEntrantes();
            cout << " conexiones entrantes." << endl << endl;
            break;

        case 4:
            cout << endl << "Hay " << computadora->numeroConexionesSalientes();
            cout << " conexiones salientes." << endl << endl;
            break;

        case 5:
            if( computadora->tresSeguidos())
                cout << endl << "Hay 3 conexiones seguidas a un sitio web" << endl << endl;
            else
                cout << endl << "No hay 3 conexiones seguidas a un sitio web" << endl << endl;
            break;

        case 6:
            cout << endl << "Webs visitadas: " << endl;
            computadora->printPuertosWEB();
            cout << endl;
            break; 
...
int menu(VectorRegistros &registros){
    ...
    cout << "8. Información de una IP dada." << endl;
    cout << "0. Salir." << endl;
    cout << "Opcion: ";
